...
export class ToolSystem {
    ...
    tools = new Map();
    executors = new Map();
    constructor(documentProvider, settingsProvider, aiClient, broadcaster) {
    ...
    registerBuiltInTools() {
        ...
        this.registerTool({
            ...
            const result = await this.documentProvider.createSuggestion(ctx.documentId, args.new_content, baseVersion, ctx.expertUserId);
            // Broadcast event
            if (this.broadcaster) {
        ...
        this.registerTool({
            ...
            if (tokenCount > LARGE_ATTACHMENT_THRESHOLD_TOKENS) {
                ...
                try {
                    ...
                    return {
                        tool: 'analyze_attachment',
                        result: `Error analyzing attachment: ${error.message}`,
                        success: false
                    };
                }
            }
...
//# sourceMappingURL=ToolSystem.js.map